...
try:
    VERSION = __import__("pkg_resources").get_distribution("dolphin").version
except Exception:
    VERSION = "unknown"
...
def get_revision():
    ...
    """
    if "DOLPHIN_BUILD" in os.environ:
        return os.environ["DOLPHIN_BUILD"]
...
def is_docker():
    ...
    # a git based image.
    return "DOLPHIN_VERSION" in os.environ or "DOLPHIN_BUILD" in os.environ
